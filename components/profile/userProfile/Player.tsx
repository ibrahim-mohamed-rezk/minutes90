                ...
                {[
                  {
                    ...
                    value: data?.injuries?.number_of_injuries || 0,
                  },
                  {
                    label: t("type_of_injury"),
                    value: data?.injuries?.injury_type || "N/A",
                  },
                  {
                    label: t("recovery_period"),
                    value: data?.injuries?.recovery_time || "N/A",
                  },
                ].map((item, index) => (
                  <div
                    key={index}
              ...
              {[
                {
                  ...
                  value: getSkillLevelName(
                    data?.skills?.heading_accuracy
                  ),
                },
                {
                  label: t("passing"),
                  value: getSkillLevelName(
                    data?.skills?.passing_accuracy
                  ),
                },
                {
                  label: t("shooting_power"),
                  value: getSkillLevelName(
                    data?.skills?.shooting_power
                  ),
                },
                {
                  label: t("tactical_awareness"),
                  value: getSkillLevelName(
                    data?.skills?.tactical_awareness
                  ),
                },
                {
                  label: t("basic_physical_skills"),
                  value: getSkillLevelName(
                    data?.skills?.physical_fitness
                  ),
                },
                {
                  label: t("endurance"),
                  value: getSkillLevelName(
                    data?.skills?.endurance_90_min
                  ),
                },
                {
                  label: t("sprint_speed"),
                  value: getSkillLevelName(data?.skills?.sprint_speed),
                },
              ].map((item, index) => (
          ...
          <div className="w-full md:w-[306px] flex flex-col gap-4 bg-[#1e1f1f] rounded-[30px] border border-[#f1f1f2] p-4">
            <div className="flex items-start justify-start gap-[10px]">
              ...
              <div className="text-white text-base font-bold font-['Montserrat']">
                {calculateAge(data?.birth_date)} years
              </div>
            </div>
              ...
              {[
                ...
                <div
                  ...
                  className={`w-[36.45px] h-[36.45px] absolute  ${
                    data?.main_position?.toUpperCase() === item.pos
                      ? "bg-[#eb4335]"
                      : data?.second_position?.toUpperCase() === item.pos
                      ? "bg-[#FBBC05]"
