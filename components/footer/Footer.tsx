...
const Footer = () => {
  return (
    <footer className="bg-[#212125] mt-[-5px]">
      <div className="bg-[#39393b] text-white rounded-[15px] border border-[#39393b] p-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="mb-8 md:mb-0">
              ...
              <p className="text-[#b7b7b7] text-lg mt-2 font-bold leading-normal">
                Elevate your football career with Minutes90. We connect players
                and agents, reshaping the future of the sport. Join our platform
            ...
            <div>
              ...
              <div className="bg-[#333333] rounded-[10px] border border-[#868686] p-2 flex flex-row items-center gap-2">
                <input
                  type="email"
              ...
              <div className="flex gap-4 mt-6">
                ...
                <a
                  href="mailto:info@minutes90.com"
                  target="_blank"
                  className="bg-[#333333] w-[66px] h-[66px] flex items-center justify-center rounded-full border border-[#868686] p-4 hover:bg-[#444444] transition"
                >
                  <svg
